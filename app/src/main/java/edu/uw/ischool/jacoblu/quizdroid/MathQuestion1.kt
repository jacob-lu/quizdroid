...
class MathQuestion1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submitbutton.setOnClickListener {
            val intent : Intent = Intent(applicationContext, MathAnswerPage::class.java)
            ...
            if(answer.equals(radiobutton2.getText().toString())) {
            ...
            intent.putExtra("ActualAnswer", radiobutton2.getText().toString())
