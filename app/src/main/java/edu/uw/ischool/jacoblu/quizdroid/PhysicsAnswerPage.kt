...
class PhysicsAnswerPage : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_physics_answer_page)
        ...
        nextButton.setOnClickListener {
            ...
            if (extras.getInt("PageNumber") == 1) {
                intent = Intent(applicationContext, PhysicsQuestion2::class.java)
            } else {
                intent = Intent(applicationContext, PhysicsQuestion3::class.java)
            }
