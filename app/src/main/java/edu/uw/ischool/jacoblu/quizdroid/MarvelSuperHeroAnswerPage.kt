...
class MarvelSuperHeroAnswerPage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        nextButton.setOnClickListener {
            ...
            if (extras.getInt("PageNumber") == 1) {
                intent = Intent(applicationContext, MarvelSuperHeroQuestion2::class.java)
            } else {
                intent = Intent(applicationContext, MarvelSuperHeroQuestion3::class.java)
            }
